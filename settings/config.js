module.exports = {
  ...
  embed: {
    ...
    footertext: "piyabordee.phongam@gmail.com",
    footericon: " ",
  },
  emoji: {
    ERROR: "❌",
  ...
  mongodb : process.env.mongodb || "mongodb+srv://piyabordee:born0269014484@cluster0.k14qlkq.mongodb.net/?retryWrites=true&w=majority",
  filters: {
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `https://discord.gg/TZgHT2dVzY`,
    VoteURL: process.env.VoteURL || `https://discord.gg/TZgHT2dVzY`,
  },
  options: {
    embedFooter: false,
    nowplayingMsg: true
